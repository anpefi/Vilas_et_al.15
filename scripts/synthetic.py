...
__version_="0.1"
# Program to make syntehtic populations
...
if __name__ == "__main__":
	...
	popsbegin=[1,2001,2101,2201,2301,2401,2501,2601] #Only for scenario A, of course. This should be adapted for other scenarios depending of the number of individuals in each line.
